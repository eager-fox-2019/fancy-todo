...
module.exports = {
    nodeMailer : function(email,type,data) {
        ...
        if(type === 'welcome'){
            info = {
                from: `"TodoApp." <${process.env.NODE_MAILER_USER}>`, // sender address
                to: `${email}`, // list of receivers
                subject: "ALERT", // Subject line
                html: `
                    <h1> WELCOME TO TodoApp. Host By dinulsyah.biz </h1>
                    <h4> we help you organize and tidy up schedule freely..</h4>
                    <a href="${clientUrl}"> Dont mind to comeback anytime. <a>                        
                ` 
            };
            ...
            info = {
                ...
                html: `
                    ...
                    <a href="${clientUrl}"> Check TodoApp. app. <a>                        
                ` 
            };
        }
