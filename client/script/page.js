  ...
  .then(({ data }) =>{
    data.forEach(el => {
      $('#list-todo').append(`
        ...
        <h5>
          <a href="#" onclick="showDescriptionTodo('${el._id}','${el.title}','${el.description}','${el.due_date}')" style="color:black">
          ${el.title}
          </a>
        </h5>
        </li>
...
function showDescriptionTodo(id,title,description,due_date) {
    ...
    data.forEach(el => {
      $('#list-project').append(`
        <li class="list-group-item d-flex justify-content-between align-items-center">
          <h5>
            <a href="#" onclick="showDetailProject('${el._id}')" style="color:black">
            ${el.title}
            </a>
          </h5>
